import { type HRONToken, type HRONValueType, type HRONTokenType, type HRONConstructor  } from "./hron";
...
export function HRONASTBuilder<TBase extends HRONConstructor>(Base: TBase) {
